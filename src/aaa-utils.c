...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// Create a native raster of the given dimensions
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SEXP create_native_raster2(int width, int height) {
  SEXP nr_ = PROTECT(Rf_allocMatrix(INTSXP, height, width)); 
  SEXP cls_ = PROTECT(Rf_mkString("nativeRaster"));
  SET_CLASS(nr_, cls_);
  // SET_ATTR(nr_, Rf_install("channels"), Rf_ScalarInteger(4));
